...
public enum EtfTimestampFormat {
    /**
     * Picoseconds
     */
    ...
    private EtfTimestampFormat(String name, int scale, double scaleFactor) {
        fName = name;
        fScale = scale;
     ...
     */
    public static EtfTimestampFormat parse(String text) {
        switch (text.toLowerCase()) {
        case "ps": //$NON-NLS-1$
            throw new IllegalArgumentException("ps not yet supported"); //$NON-NLS-1$
        case "ns": //$NON-NLS-1$
            return EtfTimestampFormat.NS;
        case "us": //$NON-NLS-1$
            return EtfTimestampFormat.US;
        case "ms": //$NON-NLS-1$
            return EtfTimestampFormat.MS;
        case "s": //$NON-NLS-1$
            return EtfTimestampFormat.S;
        default:
